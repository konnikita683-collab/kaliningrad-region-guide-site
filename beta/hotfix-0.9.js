(function(){
  ...
  function renderAges(){
    ...
    Array.prototype.forEach.call(host.querySelectorAll('[data-child-age]'),function(sel){var idx=+sel.dataset.childAge;if(ages[idx]!=null)sel.value=String(ages[idx]);sel.onchange=function(){var a=normalize(childCount()),v=sel.value;a[idx]=v===''?null:+v;write('guideGuestAges',a);var er=q('.guide-child-age-error',host);if(er)er.textContent='';};});
  }
